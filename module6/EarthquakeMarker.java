...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public void drawMarker(PGraphics pg, float x, float y) {
		...
		//pg.strokeWeight(1);
		//pg.fill(0,0,0);
		//pg.line(x-radius, y, x+radius, y);
		//pg.line((float) (x-0.2*radius), y-radius,(float) (x+0.2*radius), y+radius);
		//pg.line((float) (x-0.2*radius), y-radius,(float) (x-0.4*radius), (float) (y+0.50*radius));
		//pg.line((float) (x+0.4*radius),(float) (y-0.5*radius),(float) (x+0.2*radius), y+radius);
		//pg.line((float) (x-0.6*radius),(float) (y-0.3*radius),(float) (x-0.4*radius), (float) (y+0.50*radius));
		//pg.line((float) (x+0.4*radius),(float) (y-0.5*radius),(float) (x+0.6*radius),(float) (y+0.3*radius));
		//pg.line((float) (x-0.6*radius),(float) (y-0.3*radius),(float) (x-0.7*radius), (float) (y));
		//pg.line((float) (x+0.7*radius),(float) (y),(float) (x+0.6*radius),(float) (y+0.3*radius));
